...
export class EditorialSynthesizerAgent extends BaseAgent<SynthesizerInput, EditorialDecision> {
  ...
  protected async realExecute(input: SynthesizerInput): Promise<EditorialDecision> {
    ...
    try {
      ...
      logger.warn('EditorialSynthesizer LLM failed', String(e));
    ...
    const roadmap: RevisionItem[] = [
      {
        ...
        priority: 'P0',
        source: 'da',
        consensus: 'DA_CRITICAL',
        description: '修复核心论证的逻辑跳跃',
        suggestion: '补充因果推断方法或弱化因果声称',
        status: 'pending',
      },
      {
        id: randomUUID(),
      ...
      },
      {
        ...
        source: 'domain',
        consensus: 'CONSENSUS_3',
        description: '补充近两年核心文献',
        suggestion: '检索2024-2025年相关顶刊论文',
        status: 'pending',
      },
      {
        id: randomUUID(),
